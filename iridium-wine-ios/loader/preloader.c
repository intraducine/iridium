...
static struct wine_preload_info preload_info[] =
{
    ...
    /* The iOS-hosted x86_64 guest relocates KUSER_SHARED_DATA above Darwin's
     * low mappings. Reserve space for the shared page, syscall-dispatch thunk,
     * ntdll's TEB blocks, and virtual heap. Low guest addresses are covered by
     * Darwin's __PAGEZERO and cannot host Wine's normal first-TEB allocation. */
    { (void *)IRIDIUM_GUEST_HIGH_ARENA_ADDRESS, IRIDIUM_GUEST_HIGH_ARENA_RESERVE_SIZE },
