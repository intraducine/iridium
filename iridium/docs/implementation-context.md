...
Use the [manual validation runbook](manual-validation-runbook.md) for physical-device acceptance. A passing structural test does not prove first-frame, input or audio behavior on a device.
