...
// Derived from Madeira; Iridium helper readiness adaptation, 2026-09-09.
...
// Iridium embedded-helper adaptation: reject failed attach before notifying the host.
if (!/^[TS]/.test(attachResponse)) throw new Error("Debugger attach rejected");
...
// This marker means the script can service BRKs, not that JIT memory is ready.
log("IRIDIUM_SCRIPT_LISTENING");
while (!detached) {
