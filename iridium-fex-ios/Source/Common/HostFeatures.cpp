...
namespace {
bool GetDarwinOptionalFeature(const char* Name) {
  int Value {};
  size_t Size = sizeof(Value);
  return sysctlbyname(Name, &Value, &Size, nullptr, 0) == 0 && Value != 0;
}

uint32_t GetDarwinCacheLineSize() {
  int Value {};
  size_t Size = sizeof(Value);
...
class CPUFeaturesFromDarwin final : public FEX::CPUFeatures {
public:
  CPUFeaturesFromDarwin() {
    auto SetIfPresent = [this](const char* Name, Feature Feat) {
      if (GetDarwinOptionalFeature(Name)) {
        SetFeature(Feat);
      }
    };

    SetIfPresent("hw.optional.arm.FEAT_AES", Feature::AES);
    SetIfPresent("hw.optional.arm.FEAT_PMULL", Feature::PMULL);
    SetIfPresent("hw.optional.arm.FEAT_SHA1", Feature::SHA1);
    SetIfPresent("hw.optional.arm.FEAT_SHA256", Feature::SHA2);
    SetIfPresent("hw.optional.arm.FEAT_SHA512", Feature::SHA512);
    SetIfPresent("hw.optional.arm.FEAT_CRC32", Feature::CRC32);
    SetIfPresent("hw.optional.arm.FEAT_LSE", Feature::LSE);
    SetIfPresent("hw.optional.arm.FEAT_LSE2", Feature::LSE2);
    SetIfPresent("hw.optional.arm.FEAT_RDM", Feature::RDM);
    SetIfPresent("hw.optional.arm.FEAT_SHA3", Feature::SHA3);
    SetIfPresent("hw.optional.arm.FEAT_DotProd", Feature::DotProd);
    SetIfPresent("hw.optional.arm.FEAT_FlagM", Feature::FlagM);
    SetIfPresent("hw.optional.arm.FEAT_FlagM2", Feature::FlagM2);
    SetIfPresent("hw.optional.arm.FEAT_DIT", Feature::DIT);
    SetIfPresent("hw.optional.arm.FEAT_CSV2", Feature::CSV2);
    SetIfPresent("hw.optional.arm.FEAT_CSV3", Feature::CSV3);
    SetIfPresent("hw.optional.arm.FEAT_BTI", Feature::BTI);
    SetIfPresent("hw.optional.arm.FEAT_SSBS", Feature::SSBS);
    SetIfPresent("hw.optional.arm.FEAT_DPB", Feature::DPB);
    SetIfPresent("hw.optional.arm.FEAT_DPB2", Feature::DPB2);
    SetIfPresent("hw.optional.arm.FEAT_JSCVT", Feature::JSCVT);
    SetIfPresent("hw.optional.arm.FEAT_FCMA", Feature::FCMA);
    SetIfPresent("hw.optional.arm.FEAT_LRCPC", Feature::LRCPC);
    SetIfPresent("hw.optional.arm.FEAT_LRCPC2", Feature::LRCPC2);
    SetIfPresent("hw.optional.arm.FEAT_FRINTTS", Feature::FRINTTS);
    SetIfPresent("hw.optional.arm.FEAT_SB", Feature::SB);
    SetIfPresent("hw.optional.arm.FEAT_BF16", Feature::BF16);
    SetIfPresent("hw.optional.arm.FEAT_I8MM", Feature::I8MM);
    SetIfPresent("hw.optional.arm.FEAT_ECV", Feature::ECV);
    SetIfPresent("hw.optional.arm.FEAT_AFP", Feature::AFP);
    SetIfPresent("hw.optional.arm.FEAT_WFxT", Feature::WFxt);
    SetIfPresent("hw.optional.arm.FEAT_RPRES", Feature::RPRES);
    SetIfPresent("hw.optional.arm.FEAT_CSSC", Feature::CSSC);

    if (GetDarwinOptionalFeature("hw.optional.arm.FEAT_FP16")) {
      SetFeature(Feature::FP16);
      SetFeature(Feature::ASIMD16);
    }

    if (GetDarwinOptionalFeature("hw.optional.arm.AdvSIMD")) {
      SetFeature(Feature::FP);
      SetFeature(Feature::ASIMD);
    }

    // Keep DC ZVA disabled until the Apple host path has a verified DCZID mapping.
    DCZID.SetReg(0b1'0000);
  }
};

FEX::CPUFeatures GetCPUFeaturesFromDarwin() {
  return CPUFeaturesFromDarwin {};
}
#endif
...
FEXCore::HostFeatures FetchHostFeatures() {
  ...
  if (!CPUFeatureRegisters().empty()) {
    ...
    Features = GetCPUFeaturesFromDarwin();
#else
...
#if defined(ARCHITECTURE_arm64) && defined(__APPLE__)
  const auto CacheLineSize = GetDarwinCacheLineSize();
  HostFeatures.DCacheLineSize = CacheLineSize;
  HostFeatures.ICacheLineSize = CacheLineSize;
#endif
