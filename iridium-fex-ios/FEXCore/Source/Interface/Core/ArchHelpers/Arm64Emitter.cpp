...
Arm64Emitter::Arm64Emitter(FEXCore::Context::ContextImpl* ctx, void* EmissionPtr, size_t size, void* WritableEmissionPtr)
  : Emitter(static_cast<uint8_t*>(EmissionPtr), static_cast<uint8_t*>(WritableEmissionPtr != nullptr ? WritableEmissionPtr : EmissionPtr), size)
  , EmitterCTX {ctx}
...
void Arm64Emitter::StoreZeroToInterruptFaultPage(ARMEmitter::Register ScratchReg) {
  constexpr auto InterruptFaultPageOffset =
    offsetof(FEXCore::Core::InternalThreadState, InterruptFaultPage) - offsetof(FEXCore::Core::InternalThreadState, BaseFrameState);

  LoadConstant(ARMEmitter::Size::i64Bit, ScratchReg, InterruptFaultPageOffset);
  add(ARMEmitter::Size::i64Bit, ScratchReg, STATE, ScratchReg, ARMEmitter::ShiftType::LSL, 0);
  strb(ARMEmitter::XReg::zr, ScratchReg, 0);
}
