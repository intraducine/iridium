...
public:
  Arm64Emitter(FEXCore::Context::ContextImpl* ctx, void* EmissionPtr = nullptr, size_t size = 0, void* WritableEmissionPtr = nullptr);
  ...
  void StoreZeroToInterruptFaultPage(ARMEmitter::Register ScratchReg);
