...
# Native regression A/B branch only:
# testrepos/Madeira/FEX, wine, build, and app/Madeira/Winios are pinned to the
# 65b596 native baseline. Do not layer the later host-arena, compact-rpmalloc,
# or thread-init correction patches over that historical source, or this test
# would no longer measure the old runtime core.
printf '%s\n' 'Native baseline test: keeping 65b596 FEX/Wine sources unpatched by later Iridium corrections.'
