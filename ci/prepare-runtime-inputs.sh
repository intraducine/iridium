...
# DIAGNOSTIC: compile the 65b596 native source state without the later
# rpmalloc host-arena, compact-runtime, or FEX/Wine thread-init patches.
echo "DIAGNOSTIC: using 65b596 native baseline; skipping post-65b596 FEX/Wine correction patches"
